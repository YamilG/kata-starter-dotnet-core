...
namespace Kata.Spec
{
    ...
    public class when_adding_two_numbers
    {
        ...
        It should_return_the_sum_of_both = () => { _result.Should().Be(6); };
        static Calculator _systemUnderTest;
    ...
    public class when_user_input_includes_a_new_line_as_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_return_the_sum_of_all_numbers = () => { _result.Should().Be(8); };
        static Calculator _systemUnderTest;
        static int _result;
    }
